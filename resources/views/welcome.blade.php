    ...
    <div class="carousel-item active" style="background-image: url('/img/pokemon.png'); background-size: cover; background-position: center; height: 400px;">
      <div class="carousel-caption d-none d-md-block">
        <div class="bg-dark bg-opacity-50 p-3 rounded">
          <h5>Pokémon TCG</h5>
          <a href="{{ url('/buscar?categoria=pokemon') }}" class="btn btn-warning">Explorar Pokémon</a>
        </div>
      </div>
    </div>
    ...
    <div class="carousel-item" style="background-image: url('/img/onepiece.jpg'); background-size: cover; background-position: center; height: 400px;">
      <div class="carousel-caption d-none d-md-block">
        <div class="bg-dark bg-opacity-50 p-3 rounded">
          ...
          <a href="{{ url('/buscar?categoria=onepiece') }}" class="btn btn-danger">Ver Barajas de One Piece</a>
        </div>
      </div>
    </div>
    ...
    <div class="carousel-item" style="background-image: url('/img/digimon.jpg'); background-size: cover; background-position: center; height: 400px;">
      <div class="carousel-caption d-none d-md-block">
        <div class="bg-dark bg-opacity-50 p-3 rounded">
          ...
          <a href="{{ url('/buscar?categoria=digimon') }}" class="btn btn-primary">Descubrir Digimon</a>
        </div>
      </div>
    </div>
    ...
    <div class="carousel-item" style="background-image: url('/img/magic.jpg'); background-size: cover; background-position: center; height: 400px;">
      <div class="carousel-caption d-none d-md-block">
        <div class="bg-dark bg-opacity-50 p-3 rounded">
          ...
          <a href="{{ url('/buscar?categoria=magic') }}" class="btn btn-success">Buscar Cartas Magic</a>
        </div>
      </div>
    </div>
...
<div class="container mt-4 mb-5">
  <form action="{{ url('/buscar') }}" method="GET" class="d-flex justify-content-center">
    <input class="form-control me-2" type="search" name="q" placeholder="Buscar por nombre, categoría o usuario" aria-label="Buscar" style="max-width: 500px;">
